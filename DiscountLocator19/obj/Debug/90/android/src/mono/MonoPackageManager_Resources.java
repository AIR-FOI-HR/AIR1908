...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "DiscountLocator19.dll" comes first in this list. */
		"DiscountLocator19.dll",
		"Cheeseknife.dll",
		"core.dll",
		"database.dll",
		"Newtonsoft.Json.dll",
		...
		"Xamarin.Android.Support.RecyclerView.Selection.dll",
		...
		"XamDroid.ExpandableRecyclerView.dll",
	};
